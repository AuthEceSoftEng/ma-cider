        ...
        <div className='my-resp-padding'>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>hosting of the app and back-office functions,</li>
                    <li>editorial work; update and maintenance of data.</li>
                </ul>
                <p>
                    The concrete activities differ for in-house projects and external projects (see description of <a href="guidebook/co-creation-process/1" target="_blank" rel="noopener noreferrer">managing a co-creation project</a>). External projects should try to involve possible service providers from the beginning via the project board and work out a business plan. For in-house projects, it is necessary to ensure that the additional resources required for a permanent service provision are acknowledged in the organisation’s budget and that responsibilities are assigned.
                </p>
            </div>
            ...
            <div>
                <p>
                    Plan the transfer of a prototype to a permanent service provision. Potential service providers that may take over the co-created prototype should be identified and involved right from the start. Criteria to compare alternative options may be
                </p>
                <ul>
            ...
            <div>
                <p>
                    In order to avoid complicated and costly adaption when migrating the app and integrating it into an existing portal, technical standards, data formats, map designs, search functions etc. should be checked for compatibility as early as possible and be adhered to when <a href="guidebook/co-creation-process/5" target="_blank" rel="noopener noreferrer">co-creating software</a>.
                </p>
                <p>
                    If data is transferred at the end of the co-creation process, property rights/licensing models should be clear. When data are collected from other sources within the project and property rights have been given for the prototype they should cover the later transfer already.
                </p>
            </div>
            ...
            <div>
                <p>
                    Data collection and data maintenance have been financed with the project budget during the project. A later service provider will face costs for maintaining and updating these data. Therefore, a business and revenue plan should be developed that identifies possible revenue streams to cover these costs.
            </p>
                <p>
                    For an internal project within government an organizational assignment has to be found instead.
            </p>
            </div>
            ...
            <ul>
                ...
                <li>Make sure all necessary IPR is available. </li>
                <li>Get feedback from stakeholders on service concepts  </li>
                <li>Public launch of the product when finished <ul><li>Invite involved stakeholders and local press </li></ul></li>
                <li>Integrate/migrate the system in existing processes </li>
                <li>Explore benefits for the customer segments to allow for quantifiable estimate and measurement of effect </li>
                <li>Consider adding exploitation checkpoints into the co-creation stream to assess criteria for potential customers to pay for the service </li>
                <li>Gather input on what would be natural to pay for (value) and possible options to distinguish between a free service and a premium service </li>
