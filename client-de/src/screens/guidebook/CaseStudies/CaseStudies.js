    ...
    render() {
        ...
        return (
            <div className='my-resp-padding'>
                ...
                <p>
                    As part of the MobileAge project five co-creation case studies were conducted in four different cities and regions across Europe. Their main target audience was older adults. In each case study, older adults co-created a digital public service in collaboration with local or regional governments, social care service providers, research institutes, SMEs and/or intermediaries.
                </p>
                <h3><strong>Choose a Case study:</strong></h3>
