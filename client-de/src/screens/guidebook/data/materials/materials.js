...
export const materials = {
    '1': {
        ...
        text: 'Examples on probes for understanding socio spatial networks',
        tags: [
    ...
    '2': {
        ...
        text: 'Examples on probes for understanding social connectedness',
        tags: [
            { tag: 'method', labels: [MLABELS['CULTURAL_PROBES']] },
            { tag: 'stream', labels: [CLABELS['CO_CREATING_A_SERVICE_CONCEPT']] },
    ...
    '12': {
        ...
        text: 'Examples on the participatory definition of age-friendly routes',
        tags: [
            { tag: 'method', labels: [MLABELS['WALKING_WORKSHOPS']] },
            { tag: 'stream', labels: [CLABELS['CO_CREATING_A_SERVICE_CONCEPT'], CLABELS['WORKING_WITH_DATA']] },
    ...
    '16': {
        ...
        text: 'Examples on material provided for prototyping of user interfaces',
        tags: [
    ...
    '17': {
        ...
        text: 'Examples on results of prototyping of user interfaces',
        tags: [
            { tag: 'method', labels: [MLABELS['PROTOTYPING_PAPER_AND_DIGITAL'], MLABELS['WORKSHOP']] },
            { tag: 'stream', labels: [CLABELS['CO_CREATING_SOFTWARE']] },
            { tag: 'caseStudy', labels: [SLABELS['DIGITAL_NEIGHBOURHOOD_GUIDE']] },
...
export const materialsArray = Object.keys(materials).map(function (_) { return materials[_]; })

export const materialsTagsLabels = {
    method: Array.from(new Set(flattenArray(materialsArray.map(m => m.tags.find(t => t.tag === 'method')).map(m => m.labels)))),
    stream: Array.from(new Set(flattenArray(materialsArray.map(m => m.tags.find(t => t.tag === 'stream')).map(m => m.labels)))),
    caseStudy: Array.from(new Set(flattenArray(materialsArray.map(m => m.tags.find(t => t.tag === 'caseStudy')).map(m => m.labels)))),
    language: Array.from(new Set(flattenArray(materialsArray.map(m => m.tags.find(t => t.tag === 'language')).map(m => m.labels))))
}
