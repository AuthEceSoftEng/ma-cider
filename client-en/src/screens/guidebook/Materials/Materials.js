            ...
            .then(({ materials, materialsTagsLabels }) => {
                ...
                if (this.props.location.search && this.props.location.search) {
                    ...
                    if (query.downloadName) {
                        ...
                        if (m) {
                            downloadResourceFile(query.downloadName)
                        }
                    }
                }
            })
                ...
                <Spin size='large' spinning={loading}>
                    {!loading &&
                        <div>
                            ...
                            <h2 />
                            <p style={{ margin: '20px' }}>
                                The materials listed in this section were produced during MobileAge. They
                                are examples you might want to consider when co-creating. You can filter the
                                materials according to <strong>1)</strong> the method &nbsp;<Icon type={tagIcons['caseStudy']} />&nbsp; through which the material was produced (e.g. interview guideline), <strong>2)</strong> the associated stream(s) &nbsp;<Icon type={tagIcons['stream']} />&nbsp; of activity in which the material is useful, <strong>3)</strong> the case study &nbsp;<Icon type={tagIcons['caseStudy']} />&nbsp; in which the material was produced
