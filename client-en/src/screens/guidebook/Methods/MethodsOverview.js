                    ...
                    {!loading &&
                        <div>
                            ...
                            <p style={{ margin: '20px' }}>
                                ...
                                description, the role of a co-creation facilitator, and a reflection
                                ...
                                can filter the methods according to <strong>1)</strong> the streams &nbsp;<Icon type={tagIcons['stream']} />&nbsp; of activity in which they are most relevant
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    {method.relatedMaterials.map((rlId, k) =>
                                                        <span
                                                            key={k}
                                                            onClick={() => { downloadResourceFile(this.materials[rlId].name) }}
